...
const Partners = () => {
  ...
  const handleSubmit = (e) => {
    ...
    if (newNgo.name && newNgo.description && newNgo.imageUrl) {
      ...
      setNewNgo({ name: "", description: "", imageUrl: "" });
    }
  };
  ...
  return (
    <div className={darkTheme ? "dark-theme" : ""}>
          ...
          {partners.map((partner, index) => (
            <div className="col-md-4" key={index}>
              <div className="card h-100 text-center shadow-sm">
                <img src={partner.image} className="card-img-top p-3" alt={partner.alt} />
      ...
      <div className="container mt-4 mb-5">
        <div id="partnerCards" className="row justify-content-center g-4">
          {/* Partner cards are rendered above */}
        </div>
